...
const SlideshowImages = ({
  ...
  if (!imageSource || imageSource.length === 0) {
    return (
      <div className="relative w-full min-w-[300px] max-w-[1920px] h-[35vh] min-h-[250px] max-h-[800px] sm:h-[50vh] md:h-[60vh] lg:h-[70vh] mx-auto overflow-hidden bg-gray-200 flex items-center justify-center">
