...
export default function BrandsPage() {
  ...
  const handleViewProducts = (e, brand) => {
    e.stopPropagation() // Prevent the click from bubbling up to the card
    setSelectedBrand(brand.id)

    // Wait a moment for the products section to render before scrolling
    setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="bg-gradient-to-r from-[#2294d6] to-[#9c5f96] text-white py-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-3 w-full">
                    <button
                      ...
                      onClick={(e) => handleViewProducts(e, brand)}
                    >
