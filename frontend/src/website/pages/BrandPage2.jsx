...
export default function BrandsPage() {
  ...
  const getProductsBySubCategory = () => {
    ...
    filteredProducts.forEach(product => {
      ...
      const subCategoryName = subCategory ? subCategory.category : 'Unknown Subcategory';
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <div className="flex items-center ml-4 lg:ml-0">
                <div className="w-1 h-8 bg-[#a75d9e] mr-3"></div>
                <h1 className="text-2xl font-bold text-[#a75d9e]">Product Catalog</h1>
              </div>
            </div>
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                      !selectedBrand ? 'bg-[#a75d9e] text-white' : 'text-gray-700 hover:bg-gray-100'
                    }`}
                  >
                  ...
                  {mergedBrands.map(brand => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center justify-between ${
                        selectedBrand === brand._id ? 'bg-[#a75d9e] text-white' : 'text-gray-700 hover:bg-gray-100'
                      }`}
                    >
                      <div className="flex items-center space-x-2">
                  ...
                  <>
                    <button
                      ...
                      className={`flex-shrink-0 px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                        !selectedCategory ? 'bg-[#a75d9e] text-white' : 'text-gray-700 hover:bg-gray-100'
                      }`}
                    >
                    ...
                    {categories.map(category => (
                      <button
                        ...
                        className={`flex-shrink-0 px-4 py-2 rounded-full text-sm font-medium transition-colors ${
                          selectedCategory === category._id ? 'bg-[#a75d9e] text-white' : 'text-gray-700 hover:bg-gray-100'
                        }`}
                      >
                ...
                <div className="flex items-center space-x-4 py-3 overflow-x-auto">
                  <button
                    ...
                    className={`flex-shrink-0 px-3 py-1 rounded-full text-xs font-medium transition-colors ${
                      !selectedSubCategory ? 'bg-[#a75d9e] text-white' : 'text-gray-600 hover:bg-gray-200'
                    }`}
                  >
                    All Subcategories
                  </button>
                  {categories
                    ...
                    ?.subCategories.map(subCategory => (
                      <button
                        ...
                        className={`flex-shrink-0 px-3 py-1 rounded-full text-xs font-medium transition-colors ${
                          selectedSubCategory === subCategory.slug ? 'bg-[#a75d9e] text-white' : 'text-gray-600 hover:bg-gray-200'
                        }`}
                      >
                        ...
                        {subCategoryGroup.products.slice(0, 6).map(product => (
                          <div
                            ...
                            className={`bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${
                              viewType === 'grid' ? 'flex-shrink-0 w-64 p-4' : 'flex-shrink-0 w-80 flex items-center space-x-4 p-4'
                            }`}
